...
// import { KnowledgeBaseUpdateAndCreateForm } from './knowledge-base/knowledge-base-create';
// import { KnowledgeBaseDocuments } from './knowledge-base/knowledge-base-detail-by-id/documents/page';
// import { Datasets } from './knowledge-base';

// reimport above 3 using Dynamic import. Note to destruct the default export
const KnowledgeBaseUpdateAndCreateForm = React.lazy(() =>
  import('./knowledge-base/[id]/upload').then(
    ({KnowledgeBaseUpdateAndCreateForm}) => ({
      default: KnowledgeBaseUpdateAndCreateForm,
    })
  )
);
const KnowledgeBaseDocuments = React.lazy(() =>
  import('./knowledge-base/[id]/page').then(({KnowledgeBaseDocuments}) => ({
    default: KnowledgeBaseDocuments,
  }))
);
const KnowledgeCollections = React.lazy(() =>
  import('./knowledge-base').then(({KnowledgeCollections}) => ({
    default: KnowledgeCollections,
  }))
);

const KnowledgeBaseIntegrationPage = React.lazy(() =>
  import('./knowledge-base/[id]/integrations/page').then(
    ({KnowledgeBaseIntegrationPage}) => ({
      default: KnowledgeBaseIntegrationPage,
    })
  )
);

// const KnowledgeBaseDocuments = React.lazy(() =>
//   import('./knowledge-base/[id]/documents').then(
//     ({ KnowledgeBaseDocuments }) => ({ default: KnowledgeBaseDocuments })
//   ));
    ...
    <Layout>
      ...
      <Sider
        ...
        style={{
          ...
          // border right
          borderRight: `1px solid ${colors.brand6}`,
        }}
      >
        <Flex
          sx={{
            ...
            <Menu
              ...
              items={[
                  ...
                  children: [
                    {
                      title: 'People',
                      key: 'people',
                      label: <Link to="/customers">People</Link>,
                    },
                    {
                      title: 'Companies',
                      key: 'companies',
...

                {
                  ...
                  key: 'insights',
                  label: <Link to="/reporting">Insights</Link>,
                },
                isAdminUser
                  ? {
                      title: 'Sessions',
                      ...
                      children: [
                        ...
                        },
                        {
                          key: 'setup',
                          label: (
                            <Link to="/sessions/setup">Session setup</Link>
                          ),
                        },
                      ],
                    }
                ...
                isAdminUser
                  ? {
                      ...
                      children: [
                        ...
                        {
                          key: 'team',
                          label: <Link to="/settings/team">My team</Link>,
                          title: 'My team',
                        },
                        {
                          key: 'profile',
                        ...
                        {
                          key: 'inboxes',
                          label: <Link to="/inboxes">Inboxes</Link>,
                          title: 'Inboxes',
                        },
                        {
                          key: 'saved-replies',
                          label: (
                            <Link to="/settings/saved-replies">
                              Saved replies
                            </Link>
                          ),
                          title: 'Saved replies',
      ...
      >
        <Switch>
          ...
          <Route
            path="/knowledge-base/:collectionId/upload"
            render={() => (
          ...
          />
          <Route
            path="/knowledge-base/:collectionId/integrations"
            render={() => (
              <Suspense fallback={<Loading />}>
                <KnowledgeBaseIntegrationPage />
              </Suspense>
          ...
          />
          <Route
            path="/knowledge-base/:collectionId"
            render={() => (
              <Suspense fallback={<Loading />}>
                    ...
                    >
                      <ConfigProvider
                        theme={{
                          ...
                          token: {
                            colorPrimary: '#fc0000',
                            colorPrimaryBg: '#fc0000',
                            colorText: '#ffffff',
                            // colorTextBase: '#421717',
                          },
                          // components: {
                          //   Button: {
                          //     colorPrimary: '#ee0000'
