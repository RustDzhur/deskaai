    ...
    >
      <div
        ...
        style={{
          ...
          minWidth: CONVERSATIONS_DASHBOARD_SIDER_WIDTH,
          maxWidth: CONVERSATIONS_DASHBOARD_SIDER_WIDTH,
        }}
      >
        <Box
          className="py-4 relative overflow-hidden h-screen flex flex-col"
          sx={{
            position: 'relative',
            paddingTop: 16,
          }}
        >
          ...
          <Box>
            <Input.Search
              className="ConversationsSearchInput bg-background"
              ...
              // rootClassName={"bg-brand-6 w-full"}
              //
              // inputPrefixCls={" bg-brand-6"}
            />
          </Box>
      ...
      <section
        id="chat-detail-conversation-container"
        style={{
