...
const fetchDataDetail = (datasetId: string) => {
  return new Promise();
};

const fetchDatasetRelatedApps = (datasetId: string) => {
  return new Promise();
};
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  console.log('DatasetDetailLayout', props);
  const {
    children,
    params: {datasetId},
  } = props;
  ...
  const navigation = [
    {
      name: 'common.datasetMenus.documents',
    ...
    {
      name: 'common.datasetMenus.settings',
