...
import {accountId} from '../test-chat-page/test-chat-page';
...
const DEFAULT_FAQS: Array<FAQ> = [
  ...
  },
  {
    ...
    a: 'Yes! Try chatting with us at http://deska.ai :)',
  },
  {
  ...
  {
    q: 'Who are you?',
    a: "My name is Dominic, I'm one of the co-creators of Deska :)",
  },
  {
    q: 'Where are you?',
    a: "We're based in Seattle",
  },
];
        ...
        <Box mb={4}>
          ...
          <form onSubmit={this.handleAddNewFaq}>
            ...
            <Box mb={3}>
              ...
              <TextArea
                id="answer"
                placeholder="Hmm... it's gotta be Deska!"
                value={newAnswer}
