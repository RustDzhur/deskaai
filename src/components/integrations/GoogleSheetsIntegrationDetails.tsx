      ...
      <Container sx={{maxWidth: 720}}>
        ...
        <Box mb={4}>
          <Card sx={{p: 3}}>
            ...
            <Text type="secondary">
              Linking Deska with Google Sheets will enable you to start syncing
              your customer data to a spreadsheet instantaneously. It also will
              allow you to import customer data much more easily.
            </Text>
          </Card>
        </Box>
