    ...
    return (
      <Container sx={{maxWidth: 720}}>
        ...
        <Box mb={4}>
          ...
          <Paragraph>
            <Text>Sync messages from your Gmail inbox with Deska.</Text>
          </Paragraph>
        </Box>
        ...
        <Box mb={4}>
          <Card sx={{p: 3}}>
            ...
            <Text type="secondary">
              When you link Deska with Gmail, messages that arrive in your Gmail
              inbox will be synced with Deska. This enables you to view and
              reply to emails directly from the Deska dashboard, or from any of
              our other integrations (e.g.{' '}
