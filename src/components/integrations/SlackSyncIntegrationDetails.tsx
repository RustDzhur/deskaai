    ...
    return (
      <Container sx={{maxWidth: 720}}>
        ...
        <Box mb={4}>
          ...
          <Paragraph>
            <Text>Sync messages from your Slack channels with Deska.</Text>
          </Paragraph>
        </Box>
        ...
        <Box mb={4}>
          <Card sx={{p: 3}}>
            ...
            <Text type="secondary">
              When you link Deska with shared Slack channels or public support
              channels, you can sync message threads directly to Deska so you
