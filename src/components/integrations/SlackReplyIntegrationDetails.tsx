      ...
      <Container sx={{maxWidth: 720}}>
        ...
        <Box mb={4}>
          <Card sx={{p: 3}}>
            ...
            <Text type="secondary">
              When you link Deska with Slack, all new incoming messages will be
              forwarded to the Slack channel of your choosing. From the comfort
              of your team's Slack workspace, you can reply to and resolve
