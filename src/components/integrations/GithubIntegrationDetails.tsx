      ...
      <Container sx={{maxWidth: 720}}>
        ...
        <Box mb={4}>
          <Card sx={{p: 3}}>
            ...
            <Text type="secondary">
              When you link Deska with GitHub, Deska will automatically detect
              links to GitHub issues and pull requests, and link the issue to
              the person you're chatting with. Then, once the issue is resolved,
              it will send a private notification letting you know when the
              issue is resolved or reopened.
            </Text>
          </Card>
        </Box>
