      ...
      <Box p={3}>
        <CustomerDetailsSection title="Basic">
          <CustomerDetailsProperty
            icon={<UserOutlined style={{color: colors.primaryAccent}} />}
            name="ID"
            value={
          ...
          />
          <CustomerDetailsProperty
            icon={<MailOutlined style={{color: colors.primaryAccent}} />}
            name="Email"
            value={<CustomerDetailsPropertyValue value={email} />}
          />
          <CustomerDetailsProperty
            icon={<PhoneOutlined style={{color: colors.primaryAccent}} />}
            name="Phone"
        ...
        <CustomerDetailsSection title="Activity">
          <CustomerDetailsProperty
            icon={<CalendarOutlined style={{color: colors.primaryAccent}} />}
            name="First Seen"
            value={
          ...
          />
          <CustomerDetailsProperty
            icon={<LinkOutlined style={{color: colors.primaryAccent}} />}
            name="Last Seen URL"
        ...
        <CustomerDetailsSection title="Device">
          <CustomerDetailsProperty
            icon={<GlobalOutlined style={{color: colors.primaryAccent}} />}
            name="Timezone"
            value={getTimezoneValue(timezone)}
          />
          <CustomerDetailsProperty
            icon={<DesktopOutlined style={{color: colors.primaryAccent}} />}
            name="Browser"
          ...
          <>
            <CustomerDetailsSection title="Metadata">
              {Object.entries(metadata).map(([key, value]) => (
                <CustomerDetailsProperty
                  icon={
                    <InfoCircleOutlined style={{color: colors.primaryAccent}} />
                  }
                  key={key}
                  name={key}
...
const CompanyDetailsSection = ({company}: {company?: Company}) => {
  ...
  return (
    <CustomerDetailsSection title={title}>
      <CustomerDetailsProperty
        icon={<TeamOutlined style={{color: colors.primaryAccent}} />}
        name="Name"
