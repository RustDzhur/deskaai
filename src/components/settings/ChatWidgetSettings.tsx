...
import {ChatWidgetKnowledgeBaseSettingSection} from './ChatWidgetKnowledgeBaseSettingSection';
...
class ChatWidgetSettings extends React.Component<Props, State> {
  ...
  async componentDidMount() {
    ...
    if (widgetSettings && widgetSettings.id) {
      ...
      this.setState({
        ...
        knowledgeBaseSettings:
          knowledgeBaseSettings || this.state.knowledgeBaseSettings,
      });
    } else {
      this.setState({
        accountId,
  ...
  handleChangeKnowledgeBaseSettings = (
    knowledgeBaseSettings: KnowledgeBaseSettings
  ) => {
    this.setState({knowledgeBaseSettings}, this.debouncedUpdateWidgetSettings);
  };
  ...
  render() {
    ...
    return (
      // <Box px={5} py={4} sx={{ maxWidth: 800 }} className=''>
      <ScrollArea className="px-5 py-4 h-screen">
        <Box mb={4}>
          {inboxId ? (
            <Link to={`/inboxes`}>
        ...
        <Box mb={4}>
          ...
          <Box mb={1}>
            <label htmlFor="require_email_upfront">
              ...
              <Popover
                ...
                title={null}
              >
                <InfoCircleTwoTone twoToneColor={colors.primaryAccent} />
              </Popover>
            </label>
          </Box>
          <Box mb={3}>
          ...
          <ChatWidget
            ...
            customer={customer}
            baseUrl={BASE_URL}
            iframeUrlOverride={CHAT_IFRAME_URL}
        ...
        <Paragraph>
          <Text>
            ...
            <a
              href={GlobalConfig.chatWidgetDocUrl}
              target="_blank"
              rel="noopener noreferrer"
            >
              docs
        ...
        <ChatWidgetKnowledgeBaseSettingSection
          knowledgeBaseSettings={knowledgeBaseSettings}
          handleKnowledgeBaseSettingChange={
            this.handleChangeKnowledgeBaseSettings
          }
