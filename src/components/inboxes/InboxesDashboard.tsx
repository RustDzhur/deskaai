...
import {ConversationSideBar} from '../common/conversation-sidebar';
...
const InboxesDashboard = (props: RouteComponentProps) => {
  ...
  useAsync(API.fetchInboxes, (inboxes) => setCustomInboxes(inboxes));
  ...
  return (
    <section className="flex flex-row" style={{background: colors.bg}}>
      <aside
        ...
        style={{
          ...
          maxWidth: INBOXES_DASHBOARD_SIDER_WIDTH,
          minWidth: INBOXES_DASHBOARD_SIDER_WIDTH,
        }}
        // theme={'dark'}
      >
      ...
      <section id="chat-body" className=" h-screen bg-background w-full">
        <Switch>
          <Route
