...
export const REACT_URL = env.REACT_APP_URL || 'app.deskaai.com';

export const BASE_URL = env.REACT_APP_DEV_PROD
  ? `https://${REACT_URL}`
  : isDev
  ? 'http://localhost:4000'
  : `https://${REACT_URL}`;

export const CHAT_IFRAME_URL = env.REACT_APP_CHAT_IFRAME_URL
  ? env.REACT_APP_CHAT_IFRAME_URL
  : isDev
  ? 'http://localhost:8080'
  : `https://chat-window.deskaai.com`;
...
export const GITHUB_APP_NAME = env.REACT_APP_GITHUB_APP_NAME || 'deska';

// Defaults to Deska client ID (it's ok for this value to be public)
...
export const GlobalConfig = {
  chatWidgetDocUrl:
    'https://domng.notion.site/Installing-ChatWidget-172b2eff510f403f8a606ed2208a3303',
  liveSessionDocUrl:
    'https://domng.notion.site/Installing-Session-Recording-13c83464ae2f4de28c67f2b986d3655d',
};
